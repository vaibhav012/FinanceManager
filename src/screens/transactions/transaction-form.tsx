  ...
  <ScrollView style={styles.formScrollView}>
    <View style={styles.form}>
      ...
      <TextInput
        ...
        onChangeText={text => onUpdateTransaction(prev => (prev ? {...prev, amount: Number(text) || null} : null))}
        style={styles.input}
      />
      ...
      <View style={styles.pickerContainer}>
        <Picker
          ...
          onValueChange={itemValue => onUpdateTransaction(prev => (prev ? {...prev, accountId: itemValue} : null))}
          style={styles.picker}>
